...
setup(
    ...
    install_requires=['coverage', 'cython', 'distorm3>=0', 'elasticsearch',
                      'funcsigs', 'flask', 'filemagic', 'mock', 'pefile',
                      'py2neo', 'pymongo', 'pytest>=2.5', 'pytest-cov',
                      'rekall==1.0rc11', 'requests', 'sphinx',
                      'sphinxcontrib-napoleon', 'ssdeep==2.9-0.3', 'tabulate', 
                      'watchdog', 'yara', 'zerorpc'],
    license='MIT',
    zip_safe=False,
