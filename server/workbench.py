...
def main():
    ...
    server_uri = workbench_conf.get('workbench', 'server_uri', 'localhost')
    datastore_uri = workbench_conf.get('workbench', 'datastore_uri', 'localhost')
    database = workbench_conf.get('workbench', 'database', 'workbench')
    worker_cap = int(workbench_conf.get('workbench', 'worker_cap', 10))
    samples_cap = int(workbench_conf.get('workbench', 'samples_cap', 200))

    # API keys just get tossed into API_KEYS dict
    workbench_keys.API_KEYS['vt_apikey'] = workbench_conf.get('workbench', 'vt_apikey', '123')
