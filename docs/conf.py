...
MOCK_MODULES = ['coverage', 'cython', 'distorm3', 'elasticsearch',
                ...
                'rekall.ui', 'rekall.ui.renderer', 'bson', 'msgpack','pytz','pytest',
...
project = u'Workbench'
copyright = u'2014, SuperCowPowers LLC'
...
latex_documents = [
  ('index', 'Workbench.tex', u'Workbench Documentation',
...
man_pages = [
    ('index', 'workbench', u'Workbench Documentation',
     [u'Brian Wylie'], 1)
]
...
texinfo_documents = [
  ('index', 'Workbench', u'Workbench Documentation',
   u'Brian Wylie', 'Workbench', 'One line description of project.',
   'Miscellaneous'),
]
